...
export class db1674812091188 implements MigrationInterface {
    name = 'db1674812091188'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`supplement_tickets\` ADD \`approve_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
