...
export class db1676902263450 implements MigrationInterface {
    name = 'db1676902263450'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`time_keepings\` (\`id\` int NOT NULL AUTO_INCREMENT, \`user_id\` int NOT NULL, \`create_date\` datetime NOT NULL, \`morning_join\` datetime NULL, \`morning_leave\` datetime NULL, \`afternoon_join\` datetime NULL, \`afternoon_leave\` datetime NULL, \`odd_time\` int NULL, \`work_amount_id\` float NULL, \`work_type_id\` int NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
