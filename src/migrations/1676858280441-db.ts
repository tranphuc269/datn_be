...
export class db1676858280441 implements MigrationInterface {
    name = 'db1676858280441'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`account_request\` (\`id\` int NOT NULL AUTO_INCREMENT, \`create_person_id\` int NOT NULL, \`system_admin_id\` int NOT NULL, \`type\` int NULL, \`target_id\` int NULL, \`new_member_mail\` varchar(255) CHARACTER SET "utf8" NULL, \`first_name\` varchar(50) CHARACTER SET "utf8" NULL, \`last_name\` varchar(50) CHARACTER SET "utf8" NULL, \`is_deleted\` tinyint NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
