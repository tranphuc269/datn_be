...
export class profile1673293283068 implements MigrationInterface {
    name = 'profile1673293283068'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`national\` varchar(20) CHARACTER SET "utf8" NULL`);
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`religion\` varchar(20) CHARACTER SET "utf8" NULL`);
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`ethnicity\` varchar(20) CHARACTER SET "utf8" NULL`);
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`marital_status\` varchar(20) CHARACTER SET "utf8" NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`ticket_statuses\` DROP COLUMN \`status_name\``);
        await queryRunner.query(`ALTER TABLE \`ticket_statuses\` ADD \`status_name\` varchar(50) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`marital_status_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`ethnicity_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`religion_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`user_personals\` ADD \`national_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`ticket_statuses\` ADD \`code\` int NOT NULL`);
